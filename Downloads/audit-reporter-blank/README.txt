...
the utility like this:
	...
	$JAVA_HOME/bin/javac -sourcepath src src/com/caneraydinbey/utils/auditreporter/Runner.java -d bin
$JAVA_HOME/bin/javac -sourcepath src Downloads/audit-reporter-blank/src/com/caneraydinbey/utils/auditreporter/Runner.java -d bin

	$JAVA_HOME/bin/java -cp bin Runner resources/users.csv resources/files.csv
$JAVA_HOME/bin/java -cp bin Runner Downloads/audit-reporter-blank/resources/users.csv Downloads/audit-reporter-blank/resources/files.csv
